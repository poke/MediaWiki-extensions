<?php
/**
 * ListTransclusions extension, language file
 *
 * @author Patrick Westerhoff [poke]
 */
$messages       = array();
$messages['en'] = array(
	'listtransclusions'             => 'Transclusion list',
	...
	'listtransclusions-invalid'     => 'The specified title is invalid.',
	'listtransclusions-notexist'    => "The target page '''[[:$1]]''' does not exist.",
	'listtransclusions-tpls'        => "The following ''templates'' are used on '''[[:$1]]''':",
...
/**
 * German (Deutsch)
 * @author User:Tera on GuildWiki.de
 */
$messages['de'] = array(
	...
	'listtransclusions-invalid'     => 'Der angegebene Titel ist ungültig.',
	'listtransclusions-notexist'    => "Die Seite '''[[:$1]]''' existiert nicht.",
	'listtransclusions-tpls'        => "'''[[:$1]]''' verwendet folgende ''Vorlagen'':",
